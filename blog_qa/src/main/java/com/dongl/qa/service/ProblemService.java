package com.dongl.qa.service;

import com.dongl.qa.dao.ProblemDao;
...
public class ProblemService {
	...
	public Page<Problem> getNewProblem(String labelId ,int page, int sixe){
        Pageable pageable = PageRequest.of(page-1,sixe);
        Page<Problem> problems = problemDao.getNewProblem(labelId,pageable);
        return problems;
    }
	public Page<Problem> getHotProblem(String labelId ,int page, int sixe){
        Pageable pageable = PageRequest.of(page-1,sixe);
        Page<Problem> problems = problemDao.getHotProblem(labelId,pageable);
        return problems;
    }
	public Page<Problem> getWaitProblem(String labelId ,int page, int sixe){
        Pageable pageable = PageRequest.of(page-1,sixe);
        Page<Problem> problems = problemDao.getWaitProblem(labelId,pageable);
        return problems;
    }
