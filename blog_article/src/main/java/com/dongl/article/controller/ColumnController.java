...
import com.dongl.article.service.ColumnService;
...
public class ColumnController {
	...
	public Result findAll(){
		return Result.success("查询成功",columnService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return Result.success("查询成功",columnService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  Result.success("查询成功",  new PageResult<Column>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return Result.success("查询成功",columnService.findSearch(searchMap));
    }
