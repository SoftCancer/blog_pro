...
import com.dongl.article.service.ChannelService;
...
public class ChannelController {
	...
	public Result findAll(){
		return Result.success("查询成功",channelService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return Result.success("查询成功",channelService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  Result.success("查询成功",  new PageResult<Channel>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return Result.success("查询成功",channelService.findSearch(searchMap));
    }
